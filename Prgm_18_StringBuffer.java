class Prgm_18_StringBuffer
 {
	public static void main(String[] args)
	{
	    StringBuffer s = new StringBuffer("Shobhi");
		int p = s.length();
		int q = s.capacity();
		System.out.println("Length of string Shobhi=" + p);
		System.out.println("Capacity of string Shobhi=" + q);
        s.append(" Wolrd");
